...
imc_rrb_t* imc_rrb_merge(imc_rrb_t* vec_front, imc_rrb_t* vec_tail) {
  ...
  if(i<size2) {
    while(i!=size2) {
      copy_and_add_on_new_root(path2[i], vec);
      i++;
    }
  }
