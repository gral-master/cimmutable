...
int main(int argc, char **argv)
{
    ...
    printf("3:\n");
    ft* fingerTree3 = ft_add((void*)&data2, fingerTree2,0);
    ft* fingerTree4=  ft_add((void*)&data3, fingerTree3,0); 
    ft* fingerTree5=  ft_add((void*)&data4, fingerTree4,1);
    ft* fingerTree6=  ft_add((void*)&data5, fingerTree5,1);
    ft* fingerTree7=  ft_add((void*)&data6, fingerTree6,1);
    ft* fingerTree8=  ft_add((void*)&data7, fingerTree7,1);
